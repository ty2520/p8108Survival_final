...
cirrhosis$Drug <- mode_impute(cirrhosis$Drug)
cirrhosis$Ascites <- mode_impute(cirrhosis$Ascites)
cirrhosis$Hepatomegaly <- mode_impute(cirrhosis$Hepatomegaly)
cirrhosis$Spiders <- mode_impute(cirrhosis$Spiders)
...
# draw KM curve stratified by sex
...
model_all <- coxph(surv_obj ~ Drug + Age + Ascites + Hepatomegaly + Spiders + Bilirubin + Albumin + Edema + Copper + Alk_Phos + SGOT + Tryglicerides + Prothrombin + Cholesterol + Platelets, 
                    data = cirrhosis)
...
cox_model_td <- coxph(surv_obj ~ Age + Albumin + Bilirubin + Bilirubin*N_Days +
                      Prothrombin + Prothrombin*N_Days + SGOT, data = cirrhosis)
...
# coxph(surv_obj ~ Age + Albumin + Bilirubin + Bilirubin*N_Days + Prothrombin + Prothrombin*N_Days + SGOT, data = cirrhosis)
...
# 4, 6, 21, 37, 54, 59, 69, 71, 95, 104, 109, 110, 125, 131, 139, 160, 161, 169, 172, 190, 201, 210, 231, 245, 246, 254, 264, 265, 268, 269, 274, 276, 277, 290, 294, 305, 306, 308, 309, 310, 312, 320, 321, 326, 337, 338, 365, 378, 400, 402, 408, 412, 418
